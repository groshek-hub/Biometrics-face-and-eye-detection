...
while True:
    ...
    #img = cv2.imread("Img_8.1.png")
    #img = cv2.imread("Img_8.2.png")
    img = cv2.imread("Img_8.3.png")
    ...
    # roi = img[100:275, 215:390]  # Img_8.1.png
    # roi = img[115:300, 210:395]  # Img_8.2.
    roi = img[118:333, 245:460]  # Img_8.3.png
